...
(function(){
  define(['jquery', 'react', 'prelude-ls', 'backbone', 'gridster', 'io', 'moment', 'widget'], function($, React, Prelude, Backbone, Gridster, io, moment, widget){
    var ref$, map, filter, slice, lines, any, fold, Str, i, div, tr, td, span, kbd, button, ul, li, a, h1, h2, h3, input, form, table, th, thead, tbody, label, nav, p, ruby, rt, DEBUG, SourceModel, sources, DashboardStd, AppMain;
